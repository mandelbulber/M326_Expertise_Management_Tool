...
module.exports = function (app) {
  ...
  app.get("/api/competence/byId", [authJwt.verifyToken], controller.getById);
  ...
  app.post("/api/competence/delete", [authJwt.verifyToken, authJwt.isAdmin], controller.delete);
};